...
namespace Investing.EntityFramework.Migrations
{
    ...
    [Migration("20230106082107_AddedDividendEntity")]
    partial class AddedDividendEntity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Investing.EntityFramework.Entities.ProductDividend", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<decimal>("DividendValue")
                        .HasColumnType("numeric")
                        .HasColumnName("dividend_value");

                    b.Property<DateTime>("LastBuyDay")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("last_buy_day");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_product_dividends");

                    b.HasIndex("ClosePrice")
                        .HasDatabaseName("ix_product_dividends_close_price");

                    b.HasIndex("ClosingDate")
                        .HasDatabaseName("ix_product_dividends_closing_date");

                    b.HasIndex("DividendValue")
                        .HasDatabaseName("ix_product_dividends_dividend_value");

                    b.HasIndex("LastBuyDay")
                        .HasDatabaseName("ix_product_dividends_last_buy_day");

                    b.HasIndex("ProductId")
                        .HasDatabaseName("ix_product_dividends_product_id");

                    b.HasIndex("Title")
                        .HasDatabaseName("ix_product_dividends_title");

                    b.HasIndex("Yield")
                        .HasDatabaseName("ix_product_dividends_yield");

                    b.ToTable("product_dividends", (string)null);
                });
            ...
            modelBuilder.Entity("Investing.EntityFramework.Entities.ProductDividend", b =>
                {
                    b.HasOne("Investing.EntityFramework.Entities.Product", "Product")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_product_dividends_products_product_id");
