...
namespace Investing.EntityFramework.Migrations
{
    ...
    [Migration("20221202180946_InitDatabase")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Investing.Core.Domain.Entities.Asset", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Investing.Core.Domain.Entities.BondType", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Investing.Core.Domain.Entities.Currency", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Investing.Core.Domain.Entities.Exchange", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Investing.Core.Domain.Entities.Portfolio", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Investing.Core.Domain.Entities.Product", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Investing.Core.Domain.Entities.ProductLogo", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Investing.Core.Domain.Entities.ProductPrice", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Investing.Core.Domain.Entities.Sector", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Investing.Core.Domain.Entities.Product", b =>
                {
                    b.HasOne("Investing.Core.Domain.Entities.Asset", "Asset")
                        .WithMany("Products")
                    ...
                    b.HasOne("Investing.Core.Domain.Entities.BondType", "BondType")
                        .WithMany("Products")
                    ...
                    b.HasOne("Investing.Core.Domain.Entities.Currency", "Currency")
                        .WithMany("Products")
                    ...
                    b.HasOne("Investing.Core.Domain.Entities.Exchange", "Exchange")
                        .WithMany("Products")
                    ...
                    b.HasOne("Investing.Core.Domain.Entities.Portfolio", "Portfolio")
                        .WithMany("Products")
                    ...
                    b.HasOne("Investing.Core.Domain.Entities.Sector", "Sector")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("Investing.Core.Domain.Entities.ProductLogo", b =>
                {
                    b.HasOne("Investing.Core.Domain.Entities.Product", "Product")
                        .WithOne("Logo")
                        .HasForeignKey("Investing.Core.Domain.Entities.ProductLogo", "ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
